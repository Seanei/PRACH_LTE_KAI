            ...
            test_vectors = [
                {
                    ...
                    "expected": [2.50000000000000 + 0.00000000000000j, -0.500000000000000 - 0.500000000000000j, -0.500000000000000 + 0.00000000000000j, -0.500000000000000 + 0.500000000000000j],
                },
                {
                    "input": [1 + 0j, 0 + 0j, 0 + 0j, 0 + 0j],
                    "expected": [0.250000000000000+0j, 0.250000000000000+0j, 0.250000000000000+0j, 0.250000000000000+0j],
                },
                {
                    "input": [0 + 0j, 1 + 0j, 0 + 0j, 0 + 0j],
                    "expected": [0.250000000000000 + 0.00000000000000j, 0.00000000000000 + 0.250000000000000j, -0.250000000000000 + 0.00000000000000j, 0.00000000000000 - 0.250000000000000j],
                },
                {
                ...
                },
                {
                    ...
                    "expected": [2.21875000000000 + 0.00000000000000j, 0.812500000000000 - 2.28125000000000j, -0.343750000000000 + 0.00000000000000j, 0.812500000000000 + 2.28125000000000j]
                },
                {
                    "input": [1 + 2j, 3 - 4j, -1 + 0.5j, 0 - 2j],
                    "expected": [0.750000000000000 - 0.875000000000000j, 1.00000000000000 + 1.12500000000000j, -0.750000000000000 + 2.12500000000000j, 0.00000000000000 - 0.375000000000000j],
                },
                {
                    "input": [
                    0 + 0j,
                ...
                },
                {
                    ...
                    "expected": [-0.0131264998384584 + 0.00000000000000j,
