class PRACHSpecification:
    """Collects all PRACH specification constants used across the project.

    Every constant is a class attribute with the same value it had as a
    module-level constant in its block.
    """
